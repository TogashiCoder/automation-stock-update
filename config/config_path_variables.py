...
DOSSIER_PLATFORMS =  ROOT_DIR / "fichiers_platforms"  # Legacy: for supplier files only
ORIGINAL_PLATFORM_FILES_PATH = ROOT_DIR / "original_platform_files"  # NEW: Local original platform files
BACKUP_ORIGINAL_FILES_PATH = ROOT_DIR / "backup_original_files"  # NEW: Backup of original files
